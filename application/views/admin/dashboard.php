                ...
                <div class="col-xl-3 col-md-6">
                    <div class="card card-stats">
                        ...
                        <div class="card-body">
                            <div class="row">
                                <div class="col">
                                    <h5 class="card-title text-uppercase text-muted mb-0">Fakultas </h5>
                                    <span class="h2 font-weight-bold mb-0"><?= get_fakultas()->num_rows() ?><small> Unit </small></span>
                                </div>
                                <div class="col-auto">
    ...
    <div class="row">
        <div class="col-sm-12">
            <div class="card">
                <div class="card-body">
                    <?php
                    print_r(get_fakultas_by_nameprodi('Pend. Agama Islam (jogja)')->nama_prodi);
                    ?>
                </div>
            </div>
        </div>
